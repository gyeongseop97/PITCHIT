...
async function request(body){let data,status=200;const res={setHeader(){},status(n){status=n;return res},json(v){data=v},end(){}};await handler({method:'POST',body},res);assert.ok(status<400,JSON.stringify(data));return data;}
